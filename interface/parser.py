...
def parse_command(command_str):
    ...
    # 1. CREATE TABLE users (id:int, name:str)
    ...
    # 2. INSERT INTO users VALUES (3, 'Rex')
    ...
    # 3. SELECT FROM users
        ...
        if match:
            ...
            where = {where_col: where_val} if where_col else None
            return {"action": "select", "table": table_name, "where": where}
